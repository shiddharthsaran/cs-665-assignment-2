...
public class TestCases {
    ...
    public void testOrderUpdate(){
        ...
        Driver driver = new Driver("Driver #0", "van", foodShop);
    ...
    public void testDriverUnsubscribe(){
        Shop foodShop = new Shop("MI", "Nowhere");
        Driver driver = new Driver("Driver #1", "van", foodShop);
    ...
    public void testDriverSubscribe(){
        Shop foodShop = new Shop("MI", "Nowhere");
        Driver driverOne = new Driver("Driver #1", "van", foodShop);
        Driver driverTwo = new Driver("Driver #2", "car", foodShop);
        Driver driverThree = new Driver("Driver #3", "scooter", foodShop);
